...
<div class="overflow-hidden bg-white p-4">
                ...
                <div class="lg:max-w-lg">
                    ...
                    <dl class="mt-5 max-w-xl space-y-8 text-base/7 text-gray-600 lg:max-w-none">
                        <div class="relative pl-9">
                            ...
                            <dd class="inline"> вы получите подробные рекомендации от Тренера по выбору профессиональных инструментов и проверенных брендов — всё, что нужно для уверенного старта сразу после окончания курса.</dd>
                        </div>
                        <div class="relative pl-9">
                            <dt class="inline font-semibold text-gray-900">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                            ...
                            <dd class="inline"> чтобы вы могли как можно быстрее начать зарабатывать. Средний доход наших выпускников составляет от 400 000 тенге.</dd>
                        </div>
                        <div class="relative pl-9">
                            <dt class="inline font-semibold text-gray-900">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
 ...
 если вы внимательно проходите курс и выполняете все рекомендации, но не достигаете нужного уровня — вы можете пройти повторное обучение за счёт академии.                            <dd class="inline"></dd>
                        </div>
                    </dl>
                </div>
            </div>
