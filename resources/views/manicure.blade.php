...
Экоуход без геля, идеально подходит для клиентов с чувствительными ногтями</li>
                            </ul>
                        </div>
                        ...
                        <div class="border-t border-gray-200 pt-4">
                            <dt class="font-medium text-gray-900">🔹 Гель-покрытие под кутикулу с идеальными бликами</dt>
                            <dd class="mt-2 pb-2 text-sm text-gray-500">Вы отработаете две техники, чтобы добиться идеального покрытия и зеркального блика</dd>
                        </div>
                        <div class="border-t border-gray-200 pt-4">
                            <dt class="font-medium text-gray-900">🔹 Формы ногтей: от овала до миндаля</dt>
                            <dd class="mt-2 pb-2 text-sm text-gray-500">Пошаговая техника правильного опила и подбора формы под руку клиента.</dd>
                        </div>
                        <div class="border-t border-gray-200 pt-4">
